...
df <- read.csv("c:\\users\\chris\\GitHub\\unir\\figure-4.csv", header = FALSE)
...
& (Size == 524288 & Latency == "20" & is.element(Concurrency, c(2, 4, 6, 8, 16, 32, 64, 128))))
