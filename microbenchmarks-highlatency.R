...
df <- read.csv("c:\\users\\chris\\GitHub\\unir\\microbenchmarks-highlatency.csv", header = FALSE)
...
ggsave("c:\\users\\chris\\github\\unir\\Microbenchmarks-HighLatency.png", dpi = 400)
